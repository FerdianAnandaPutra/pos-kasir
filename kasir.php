			...
			<table class="table table-bordered">
				...
				<?php foreach ($_SESSION['cart'] as $key => $value): ?>
					<tr>
						...
						<td><?=number_format((int)$value['qty'] * (float)$value['harga'])?></td>
						<td><a href="keranjang_hapus.php?id=<?=$value['id']?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a></td>
					</tr>
				<?php endforeach; ?>
			<?php endif; ?>
			</table>
